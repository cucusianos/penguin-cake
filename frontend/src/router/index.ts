...
import WaimaiManage from '../views/WaimaiManage.vue'
...
export const router = createRouter({
  ...
  routes: [
    ...
    {
      path: '/middle', component: MiddleLayout, children: [
        { path: '', component: MiddleDashboard },
        { path: 'orders', component: OrderStatus },
        { path: 'waimai', component: WaimaiManage },
    ...
    {
      path: '/back', component: BackendLayout, children: [
